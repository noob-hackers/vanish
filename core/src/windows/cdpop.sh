...
rm * >/dev/null 2>&1
cd $HOME
cp $HOME/vanish/core/src/windows/CdDriveUpdate.bat /sdcard/vanrc >/dev/null 2>&1
clear
echo -e "\e[91m   
                ┌─┐┌┬┐  ┌─┐┌─┐┌─┐
                │   ││  ├─┘│ │├─┘
                └─┘─┴┘  ┴  └─┘┴"
echo
echo -e "        \e[91m[\e[0mthe CD drives constantly pop out.\e[91m]\e[0m"
